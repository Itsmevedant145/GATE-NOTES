  ...
  const topics = [
    ...
    },
    {
      ...
      notes: [
        ...
        "Subgroup: Subset that is also a group",
        "Lagrange's theorem: |H| divides |G| for subgroup H"
      ],
      formulas: [
        "Lagrange's theorem: |G| = |H| × [G:H] where [G:H] is index",
        "Order of element divides order of group",
        "Cyclic group of order n has φ(n) generators where φ is Euler's totient"
      ],
      tips: "CAII: Closure, Associativity, Identity, Inverse - four group axioms. Check all for group proof."
    },
    {
      id: 21,
      ...
      priority: "medium",
      notes: [
        "Lattice: Poset where every two elements have LUB and GLB",
        "Boolean algebra: Lattice with 0, 1, and complement",
        "Properties: Idempotent, Commutative, Associative, Distributive",
        "De Morgan's Laws: (a∨b)' = a'∧b' and (a∧b)' = a'∨b'",
      ...
      tips: "Boolean algebra is basis for digital logic. ∨ = OR, ∧ = AND, ' = NOT"
    },
    {
      id: 22,
